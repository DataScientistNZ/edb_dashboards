...
One simple way to attempt to observe such pattern is to compute the correlation, for each EDB, between the cost signal and the interruption signal;
...
my_scatter_gplot(data.table(dt_tmp)[veg_saifi_next1 == 0, veg_saifi_next1 := 0.001][], x_var="veg_saifi_next1", 
                 y_numerator="veg_mgt_opex", y_denominator="overhead_length", 
...
my_scatter_gplot(data.table(dt_tmp)[veg_saifi_next2 == 0, veg_saifi_next2 := 0.001][], x_var="veg_saifi_next2", 
                 y_numerator="veg_mgt_opex", y_denominator="overhead_length", 
...
my_scatter_gplot(data.table(dt_tmp)[veg_saifi_next3 == 0, veg_saifi_next3 := 0.001][], x_var="veg_saifi_next3", 
                 y_numerator="veg_mgt_opex", y_denominator="overhead_length", 
...
my_scatter_gplot(data.table(dt_tmp)[veg_saifi_next4 == 0, veg_saifi_next4 := 0.001][], x_var="veg_saifi_next4", 
                 y_numerator="veg_mgt_opex", y_denominator="overhead_length", 
...
<h5>Econometrics to the rescue?</h5>
