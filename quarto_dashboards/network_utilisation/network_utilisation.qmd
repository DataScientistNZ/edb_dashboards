...
## text into model
<h5>Utilisation in 2024 presented against nomber of customers or line length</h5>
This page presents the aggregated utilisation for all EDBs against either:
...
dt_agg_clean <- merge(dt_agg_clean, dt_extra)
dt_agg <- merge(dt_agg, dt_extra)
